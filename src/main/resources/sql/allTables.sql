...
/* Open tenders */
  ...
  (/* 4 */  13, 'Truck fo beer',       CURDATE(),    '2014-06-04', 1, 4000.00,  'Need free deliver'),
  ...
  (/* 9 */  13, 'Products',            CURDATE(),    '2014-06-15', 1, 9000.00,  NULL),
...
/* Tenders in progress */
  ...
  (/* 14 */ 13, 'House building ',    '2014-04-25', CURDATE(),    2, 14000.00, NULL),
  ...
  (/* 19 */ 13, 'Need products',      '2014-06-08', '2014-06-17', 2, 19000.00, NULL),
...
/* Closed tenders */
  ...
  (/* 24 */ 15, 'House building',     '2014-04-25', CURDATE(),    3, 24000.00, NULL),
