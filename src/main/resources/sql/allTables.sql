...
/* Open tenders */
  (/* 1 */  11, 'Music instruments',   '2014-06-10', '2014-07-10', 1, 1000.00,  NULL),
  (/* 2 */  12, 'Apartments building', CURDATE(),    '2014-06-03', 1, 2000.00,  'I want free deliver'),
  (/* 3 */  13, 'Haus building',       '2014-04-10', CURDATE(),    1, 3000.00,  NULL),
  (/* 4 */  14, 'Truck fo beer',       CURDATE(),    '2014-06-04', 1, 4000.00,  'Need free deliver'),
  (/* 5 */  15, 'Animals',             '2014-05-28', '2014-06-18', 1, 5000.00,  'I need fast deliver'),
  (/* 6 */  11, 'Tourism',             '2014-04-12', CURDATE(),    1, 6000.00,  NULL),
  (/* 7 */  12, 'Industry',            '2014-06-07', '2014-06-28', 1, 7000.00,  NULL),
  (/* 8 */  13, 'Need products',       '2014-06-08', '2014-06-17', 1, 8000.00,  'I want deliver to some specific place'),
  (/* 9 */  14, 'Products',            CURDATE(),    '2014-06-15', 1, 9000.00,  NULL),
  (/* 10 */ 15, 'Products',            CURDATE(),    '2014-06-18', 1, 10000.00, NULL),

/* Tenders in progress */
  (/* 11 */ 11, 'All in one',         CURDATE(),    '2014-06-22', 2, 11000.00, NULL),
  (/* 12 */ 12, 'Products',           '2014-06-10', '2014-06-25', 2, 12000.00, 'I want free deliver to some specific place'),
  (/* 13 */ 13, 'Builders',           '2014-05-11', '2014-06-16', 2, 13000.00, NULL),
  (/* 14 */ 14, 'House building ',    '2014-04-25', CURDATE(),    2, 14000.00, NULL),
  (/* 15 */ 15, 'Cars',               CURDATE(),    '2014-06-22', 2, 15000.00, 'Firm need fast deliver'),
  (/* 16 */ 11, 'Cars for my firm',   '2014-06-09', '2014-06-19', 2, 16000.00, NULL),
  (/* 17 */ 12, 'House Building',     '2014-04-12', '2014-06-11', 2, 17000.00, NULL),
  (/* 18 */ 13, 'Industry',           '2014-06-07', '2014-06-28', 2, 18000.00, NULL),
  (/* 19 */ 14, 'Need products',      '2014-06-08', '2014-06-17', 2, 19000.00, NULL),
  (/* 20 */ 15, 'Need products',      CURDATE(),    '2014-06-15', 2, 20000.00, 'I want free deliver'),

/* Closed tenders */
  (/* 21 */ 11, 'Products',           CURDATE(),    '2014-06-18', 3, 21000.00, NULL),
  (/* 22 */ 12, 'Products',           '2014-06-10', '2014-06-25', 3, 22000.00, NULL),
  (/* 23 */ 13, 'Need workers',       '2014-05-11', '2014-06-16', 3, 23000.00, NULL),
  (/* 24 */ 14, 'House building',     '2014-04-25', CURDATE(),    3, 24000.00, NULL),
  (/* 25 */ 15, 'I want find cars',   CURDATE(),    '2014-06-22', 3, 25000.00, 'I want deliver to some specific place'),
