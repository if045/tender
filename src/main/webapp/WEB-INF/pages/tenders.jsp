        ...
        <div class="panel panel-default sidebar">
            ...
            <div class="panel-body">
                <div>
                    <div>Category</div>
                    <div>
                        <select id="category_filter" multiple="multiple"
                                class="populate placeholder select2-offscreen category_selector" tabindex="-1">
                            <option></option>
                        ...
                        <select id="location_filter" multiple="multiple"
                            ...
                            <optgroup label="Regions">
                                <c:forEach var="location" items="${locations}">
                                    <option><c:out value="${location.name}"></c:out></option>
                                </c:forEach>
                            </optgroup>
                        </select>
                    </div>
                ...
                <div>
                    ...
                    <div>
                        <input type="price_from" class="pull-left form-control suitable_price" id="price_from"
                               placeholder="From">
                        <input type="price_to" class="pull-right form-control suitable_price" id="price_to"
                               placeholder="To">
                    </div>
                </div>
                <div>
                    ...
                    <div class="date_filter">
                        <div class="input-group date pull-left" id="startDate" data-date="29-03-2013"
                             data-date-format="dd-mm-yyyy">
                            <input class="form-control" size="10" type="text" value="29-03-2013">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
                        <div class="input-group date pull-right" id="endDate" data-date="29-03-2013"
                             data-date-format="dd-mm-yyyy">
                            <input class="form-control" size="10" type="text" value="29-03-2013">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
                ...
                <div>
                    ...
                    <div class="pull-right">
                        <button type="button" class="btn btn-default" disabled>Clear filters</button>
                    </div>
                </div>
            </div>
        </div>
